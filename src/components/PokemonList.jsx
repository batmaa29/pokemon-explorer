...
export default function PokemonList({ pokemon, loading, error }) {
  ...
  return (
    <main className="pokedex">
      <section className="hero pokedex-hero">
        <div className="pokedex-hero-content"><p className="eyebrow">Batsss collection · 001—151</p><h1>Find your next <span>favorite.</span></h1><p>Browse the original Pokédex and learn something new.</p></div>
        <div className="hero-ball pokedex-hero-ball" aria-hidden="true"><div /></div>
      </section>
