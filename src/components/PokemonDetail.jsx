...
export default function PokemonDetail({ pokemon, onClose }) {
  ...
  const modal = (
    <div className="fixed inset-0 z-[9999] pointer-events-none">
      ...
      <div
        className={`pointer-events-auto bg-white border-2 border-black p-3 sm:p-4 rounded-xl text-black relative transform transition-all duration-200 shadow-2xl ${visible ? 'scale-100 opacity-100' : 'scale-95 opacity-0'}`}
